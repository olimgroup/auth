...
import (
	...
	"github.com/olimgroup/auth/providers/password/encryptor"
	"github.com/olimgroup/auth/providers/password/encryptor/bcrypt_encryptor"
...
func (provider Provider) ConfigAuth(auth *auth.Auth) {
	auth.Render.RegisterViewPath("github.com/olimgroup/auth/providers/password/views")

	if auth.Mailer != nil {
		auth.Mailer.RegisterViewPath("github.com/olimgroup/auth/providers/password/views/mailers")
	}
}
